...
const RegisterModal = ({ setModal}) => {
  ...
  const handleRegister = () => {
    console.log("Burada kullanıcı bilgilerini veritabanına kaydetmek gerek.Simdilik atlıyorum ve kayıt işlemi başarılıymış gibi login sayfasına devam ediyorum.");
    ...
    <header className={`absolute text-center   bg-white bg-opacity-20 backdrop-blur-xl  drop-shadow-lg  box-shadow rounded-2xl  opacity-2 border-2 border-white w-[400px] h-[450px] translate-x-[550px] translate-y-[80%]`}>
      ...
      <div className='flex flex-col justify-center gap-y-12 relative top-[70px]'>
          <div className='flex flex-row justify-between m-auto relative'>
            ...
            <button className='font-semibold text-xl text-center relative  -top-[70px] left-[50px] bg-blue-500 w-[300px] h-[40px] rounded-md' onClick={handleRegister}>Register</button>
